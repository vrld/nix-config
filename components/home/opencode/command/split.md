---
description: Split the working copy into multiple changes.
---

# Group Changes

You are tasked with grouping the changes made during this session. Each group
will be a jujutsu revision.
...
1. **Think about what changed:**
   ...
   - Review the `jj status` to get an idea of what files changed
   - Consider whether changes should be one commit or multiple logical commits
   - Use `jj diff` on specific files if you need more context. Only do this if you have no knowledge of the changes in that file.

2. **Group files into changesets:**
...
3. **Present your plan to the user:**
   - List the files in each change
   - Show the commit message(s) you'll use (including the commit type prefix)
   - Ask: "I plan to create [N] commit(s) with these changes. Shall I proceed?"

4. **Execute upon confirmation:**
   - Ask @jujutsuka to split the current change into the groups you found
